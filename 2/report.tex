...
The figures figure $\ref{fig:cow_rec_us_1}$, figure $\ref{fig:cow_rec_us_2}$, figure $\ref{fig:cow_rec_us_3}$ and figure $\ref{fig:cow_rec_us_4}$ show the reconstructed 3d points using our estimated rotation translation matrix $R$ and estimated translation vector $t$.
